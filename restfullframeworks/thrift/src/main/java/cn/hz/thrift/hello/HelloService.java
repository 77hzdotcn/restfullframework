...
public class HelloService {
  ...
  public interface Iface {
    ...
    public HelloStruct sayHello(String name) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public HelloStruct recv_sayHello() throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class sayHello_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public HelloStruct getResult() throws org.apache.thrift.TException {
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class sayHello<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, sayHello_args, HelloStruct> {
      public sayHello() {
        super("sayHello");
      }
      ...
      public AsyncMethodCallback<HelloStruct> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<HelloStruct>() { 
          public void onComplete(HelloStruct o) {
            sayHello_result result = new sayHello_result();
            result.success = o;
            try {
      ...
      public void start(I iface, sayHello_args args, org.apache.thrift.async.AsyncMethodCallback<HelloStruct> resultHandler) throws TException {
  ...
  public static class sayHello_result implements org.apache.thrift.TBase<sayHello_result, sayHello_result._Fields>, java.io.Serializable, Cloneable, Comparable<sayHello_result>   {
    ...
    public HelloStruct success; // required
    ...
    public sayHello_result(sayHello_result other) {
      if (other.isSetSuccess()) {
        this.success = new HelloStruct(other.success);
      }
    }
    ...
    public HelloStruct getSuccess() {
      return this.success;
    }

    public sayHello_result setSuccess(HelloStruct success) {
      this.success = success;
      return this;
    }
          ...
          switch (schemeField.id) {
            case 0: // SUCCESS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.success = new HelloStruct();
